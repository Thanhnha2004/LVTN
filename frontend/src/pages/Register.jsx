      ...
      <div style={{ width: 440 }}>
        ...
        <div className="card border-0 shadow-lg" style={{ borderRadius: 16 }}>
          <div className="card-body p-4">
            <h5 className="fw-bold mb-1">Tạo tài khoản mới</h5>
            <p className="text-muted small mb-4">
              Tham gia BDS Platform ngay hôm nay!
            </p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Vai trò */}
              <div className="mb-4">
                <label className="form-label fw-semibold small">Bạn muốn</label>
                <div className="row g-2">
                  <div className="col-6">
                    <div
                      ...
                      style={{
                        cursor: "pointer",
                        background: form.role === "buyer" ? "#e8f4f8" : "#fff",
                        transition: "all 0.2s",
                      }}>
                      <div className="fw-semibold small">Tìm BĐS</div>
                  ...
                  <div className="col-6">
                    <div
                      ...
                      style={{
                        cursor: "pointer",
                        background: form.role === "owner" ? "#e8f4f8" : "#fff",
                        transition: "all 0.2s",
                      }}>
                      <div className="fw-semibold small">Đăng tin</div>
                      <div className="text-muted" style={{ fontSize: 11 }}>
                        Owner
                      </div>
                    </div>
